...
public class ScaleInput {
    ...
    /**
     * Applies a reverse exponential curve to the input, typically for de-scaling
     * values.
     * 
     * @param input     The input value to be reverse curved, expected to be in the
     *                  range [0, 1].
     * @param intensity The intensity of the reverse curve, a higher value makes the
     *                  curve steeper, expected to be in the range [0, 20].
    ...
    /**
     * Scales the input powers for left and right sides of a tank drive to allow for
     * smoother turning and power application.
     * 
     * @param leftpwr            The power input for the left side, expected to be
     *                           in the range [-1, 1].
     * @param rightpwr           The power input for the right side, expected to be
     *                           in the range [-1, 1].
     * @param deadzone           The deadzone for the inputs, below which the input
     *                           is considered to be zero.
     * @param turnCurveIntensity The intensity of the curve applied to the turn
     *                           component, 7 is recommended, expected to be in the
     *                           range [0, 20].
     * @param pwrCurveIntensity  The intensity of the curve applied to the power
     *                           component, 5 is recommended, expected to be in the
     *                           range [0, 20].
     * @return A Pair object containing the scaled power values for the left and
     *         right sides.
     */
    public static Pair<Double> scale(double leftpwr, double rightpwr, double deadzone,
        ...
        // Scale the average of the powers and the difference of the powers
        // independently
    ...
    /**
     * Normalizes a pair of power values so that both are within the range [-100,
     * 100].
     * If one value is over 100, both values are scaled down proportionally.
     * 
     * @param inp A Pair of double values representing power that may need
     *            normalization.
