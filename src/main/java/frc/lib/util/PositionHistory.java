...
/**
 * Maintains a history of positions over time to calculate speed and
 * acceleration.
 */
public class PositionHistory {
    ...
    private double getSpeed(int i) {
        ...
        // Speed is calculated as the difference in position over the difference in
        // time.
    ...
    /**
     * Calculates the acceleration based on the speed changes between the most
     * recent positions.
     *
    ...
    public double getAcceleration() {
        ...
        var prev = pos.size() - 2;
        // Acceleration is calculated as the difference in speed over the difference in
        // time.
