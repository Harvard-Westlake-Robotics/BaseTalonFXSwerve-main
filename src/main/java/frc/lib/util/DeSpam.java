...
/**
 * The DeSpam class is a utility to prevent a piece of code from running too
 * frequently,
...
public class DeSpam {
    ...
    /**
     * Executes the given function if the minimum time has elapsed since the last
     * execution.
     *
    ...
    public boolean exec(Lambda func) {
        // Check if the current time is greater than the last execution time plus the
        // minimum difference.
